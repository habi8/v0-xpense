...
export default function DashboardClient({ user, initialTransactions }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div
        className={`fixed top-[82px] md:top-[116px] left-0 right-0 z-40 bg-background/95 backdrop-blur-sm ${loggingOut ? "opacity-0" : "opacity-100"} transition-opacity duration-300`}
      >
