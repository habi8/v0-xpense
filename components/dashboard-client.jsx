...
export default function DashboardClient({ user, initialTransactions }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Fixed Tabs */}
      <div
        className={`fixed top-[94px] md:top-[108px] left-0 right-0 z-40 bg-background/95 backdrop-blur-sm ${loggingOut ? "opacity-0" : "opacity-100"} transition-opacity duration-300`}
      >
