...
export default function DashboardClient({ user, initialTransactions }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Fixed Header */}
      <div
        className={`fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm p-4 md:p-8 ${loggingOut ? "opacity-0" : "opacity-100"} transition-opacity duration-300`}
      >
      ...
      <div
        className={`fixed top-[86px] md:top-[116px] left-0 right-0 z-40 bg-background/95 backdrop-blur-sm ${loggingOut ? "opacity-0" : "opacity-100"} transition-opacity duration-300`}
      >
